...
const ClientModal = ({
  ...
  const handleSubmit = async () => {
    ...
    if (mode === "create") {
      ...
      // const idBackBase64 = await convertFileToBase64(formState.idBack);
      // const idFrontBase64 = await convertFileToBase64(formState.idFront);
      // const profilePictureBase64 = await convertFileToBase64(formState.profilePicture);
      ...
      const clientIndex = clientsData.findIndex((client) => client.userId === formState.userId);
  
      if (clientIndex > -1) {
        clientsData[clientIndex] = {
          ...clientsData[clientIndex],
          ...formState,
          // profilePicture: formState.profilePicture ? formState.profilePicture : profilePicture,
          // idFront: formState.idFront ? formState.idFront : idFront,
          // idBack: formState.idBack ? formState.idBack : idBack,
                          ...
                          >
                            ...
                            {Object.entries(employmentStatus).map(([key, value]) => (
                              <option
                                key={key}
                                value={key}
                                selected={key === formState.employmentStatus}
                              >
                                {value}
                              </option>
                              ))}
                          ...
                          >
                            ...
                            {Object.entries(otherIncome).map(([key, value]) => (
                              <option
                                key={key}
                                value={key}
                                selected={key === formState.otherIncome}
                              >
                                {value}
                              </option>
                              ))}
